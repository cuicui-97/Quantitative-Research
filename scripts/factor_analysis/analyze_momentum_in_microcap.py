...
测试因子：
1. Reversal_5d - 5日反转（预期短期反转有效）
2. Momentum_20d - 20日动量（预期中期动量有效）
3. Momentum_60d - 60日动量（预期季度动量有效）
"""
import sys
...
def main():
    logger = setup_logger(prefix="momentum_microcap")

    logger.info("="*70)
    logger.info("微盘股内动量/反转因子分析")
    logger.info("="*70)
